...
if __name__ == '__main__':
    ...
    with fiona.open('/tmp/hand_021/hand_021.shp') as fc:
        for feature in fc:
            ...
            running_extent = (min(running_extent[0], bbox[0]), max(running_extent[1], bbox[1]), min(running_extent[2], bbox[2]), max(running_extent[3], bbox[3]))
    ...
    overall_extent = Extent(
        SpatialExtent([running_extent[0], running_extent[1], running_extent[2], running_extent[3]]),
